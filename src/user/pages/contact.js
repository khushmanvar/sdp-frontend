...
export default function Contact() {
  return (
<div class="relative flex items-top justify-center min-h-screen bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 dark:bg-gray-900 sm:items-center sm:pt-0">
            ...
            <div class="mt-8 overflow-hidden">
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6 mr-2 dark:bg-gray-800 sm:rounded-lg">
                        ...
                        <p class="text-normal text-lg sm:text-2xl font-medium dark:text-gray-400 mt-2">
