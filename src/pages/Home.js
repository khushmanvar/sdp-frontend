    ...
    <div class="px-12 mx-auto max-w-7xl">
        <div class="w-full mx-auto text-left md:w-11/12 xl:w-9/12 md:text-center">
            <h1 class="mb-8 text-4xl font-extrabold leading-none tracking-normal text-gray-900 md:text-6xl md:tracking-tight">
                <span>Start your</span> <span class="block w-full py-2 text-transparent bg-clip-text leading-12 bg-gradient-to-r from-green-400 to-purple-500 lg:inline">instant boking</span> <span>journey <br></br> with easybus 🚀</span>
            </h1>
...
<div class="flex bg-gray-100 py-24 justify-center">
    <div class="p-12 text-center max-w-2xl">
        ...
        cursor-pointer bg-green-600 rounded text-lg tr-mt  svelte-jqwywd">Grab Your Seat</div>
        </div>
    </div>
</div>
